...
| Generic terminal-leaf mutation | checkpoint 1 pending | 1 tree mutation | 0 | production, compact, forest, incremental, scanner-aware corpus, and Go C-oracle receipts |
